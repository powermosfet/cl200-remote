...
namespace remote {
  class Config {
    public:
      ...
      static const unsigned int CH1_BUTTON_PIN  = 8;
      static const unsigned int CH2_BUTTON_PIN  = 9;
      static const unsigned int CH3_BUTTON_PIN  = 10;
      static const unsigned int CH4_BUTTON_PIN  = 11;
      static const unsigned int TAPE_BUTTON_PIN = 12;
